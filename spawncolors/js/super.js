...
.replace("pfister811","2067225984")
.replace("bullet","1332930961")
.replace("cheetah","468058146")
.replace("entityxf","355740376")
.replace("etr1","1973475530")
.replace("fmj","1080778075")
.replace("infernus","1241314157")
.replace("italigtb","1699567743")
.replace("nero","712707143")
.replace("osiris","1002199155")
.replace("penetrator","1976357173")
.replace("re7b","1816254385")
.replace("tempesta","1753703956")
.replace("t20","772834071")
.replace("turismor","1339193518")
.replace("tyrus","955729842")
.replace("vacca","897912863")
.replace("voltic","114045201")
.replace("zentorno","1975497006")
.replace("x80proto","509057072")
